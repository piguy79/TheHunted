(defproject code "0.0.1-SNAPSHOT"
  ...
  :dependencies [[com.badlogicgames.gdx/gdx "1.6.0"]
                 [com.badlogicgames.gdx/gdx "1.6.0" :classifier "sources"]    
                 [com.badlogicgames.gdx/gdx-backend-lwjgl "1.6.0"]
                 [com.badlogicgames.gdx/gdx-backend-lwjgl "1.6.0" :classifier "sources"]
                 [com.badlogicgames.gdx/gdx-box2d "1.6.0"]
                 [com.badlogicgames.gdx/gdx-box2d "1.6.0" :classifier "sources"]
  ...
  :aot [code.core.desktop-launcher]
  :main code.core.desktop-launcher)
